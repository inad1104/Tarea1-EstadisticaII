...
```
A través de los resultados anteriores, la función aplicada con el criterio AIC mostró que la densidad que mejor se acopla a los datos es una distribución normal estándar.   
...
#### 4.
Debido a la forma que tienen la distribución normal y la distribución Weibull cuando se grafican, se ha llegado a la conclusión que la función que mejor se adapta a los datos es la distribución de Weibull. 
